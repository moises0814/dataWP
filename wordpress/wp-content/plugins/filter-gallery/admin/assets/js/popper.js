...
(function(e, t) {
	...
	function() {
		...
		function F(e, t, o, i) {
			o.updateBound = i, A( e ).addEventListener(
				'resize',
				o.updateBound,
				{
					passive: ! 0
		...
		function R(e, t) {
			return A( e ).removeEventListener( 'resize', t.updateBound ), t.scrollParents.forEach(
				function(e) {
		...
		ue              = function() {
			function t(o, n) {
				...
				de( this, t ), this.scheduleUpdate = function() {
					...
					isCreated: ! 1,
					scrollParents: []
				}, this.reference                  = o && o.jquery ? o[0] : o, this.popper = n && n.jquery ? n[0] : n, this.options.modifiers = {}, Object.keys( fe( {}, t.Defaults.modifiers, r.modifiers ) ).forEach(
					function(e) {
			...
			modifiers: {
				...
				applyStyle: {
					...
					onLoad: function(e, t, o, n, i) {
						...
						return t.setAttribute( 'x-placement', p ), j(
							t,
							{
