...
<div class="avantex-extras-page shadow-lg bg-light h-100 p-3">
	<h1>Avantex Extras</h1>
	<p>Thanks for choosing Avantex. Please have a look at our various builds!</p>
</div>
...
<div class="container-full">
	...
	<div class="row row-cols-1 row-cols-md-4 justify-content-center g-4">
		<?php
		$plugin_button      = '';
		$frank_plugin_slugs = array( 'filter-gallery', 'flickr-album-gallery', 'slider-factory', 'ultimate-responsive-image-slider' );
			...
			if ( ! is_wp_error( $extras_info ) ) {
				...
				if ( ! is_wp_error( $plugin_info ) ) {
					...
					switch ( $plugin_install_status['status'] ) {
						case 'install':
							$plugin_button = '<button href="#" class="btn btn-dark" onclick="extrasAjaxRequest(\'' . esc_html( $plugin_slug ) . '\', \'extras_plugin_install\', this)">Install Now</button>';
							break;
						case 'update_available':
							$plugin_button = '<button href="#" class="btn btn-dark" onclick="extrasAjaxRequest(\'' . esc_html( $plugin_slug ) . '\', \'extras_plugin_update\', this)">Update Now</button>';
							break;
						...
						case 'newer_installed':
							...
							if ( is_plugin_active( $plugin_name ) ) {
								$plugin_button = '<button type="button" class="btn btn-success" disabled>Installed/Activated</button>';
							} else {
								$plugin_button = '<button href="#" class="btn btn-dark" onclick="extrasAjaxRequest(\'' . esc_html( $plugin_slug ) . '\', \'extras_plugin_activate\', this)">Activate Now</button>';
							}
							break;
					}
				}
				...
				<div class="col">
					...
					<img class="card-img-top" src="<?php echo esc_url( $src ); ?>" alt="<?php echo esc_attr( $alt ); ?>">
						<div class="card-body">
	...
	<div class="row row-cols-1 row-cols-md-4 justify-content-center g-4">
		...
		// Themes Start.
		$theme_button      = '';
		$frank_theme_slugs = array( 'crypto-airdrop', 'businessexpo', 'architect-designs', 'crypto-mining', 'crypto-compare', 'building-construction', 'crypto-token', 'medical-health' );
		// Fetch theme data.
		foreach ( $frank_theme_slugs as $theme_slug ) {
			...
			if ( ! is_wp_error( $thm_extras_info ) ) {
				...
				<div class="col">
					<div class="card shadow-lg bg-light h-100">
						<img class="card-img-top" src="<?php echo esc_url( $thm_screenshot_url ); ?>" alt="<?php echo esc_attr( $thm_name ); ?>">
						<div class="card-body">
						...
						<p class="card-text text-center btn-formatting mt-1">
							...
							switch ( $thm_name ) {
								case 'Crypto AirDrop':
									$thm_demo_link = 'https://wpfrank.com/demo/crypto-airdrop-premium/';
									$thm_buy_link  = 'https://wpfrank.com/wordpress-themes/crypto-airdrop-premium/';
									break;
								case 'BusinessExpo':
									$thm_demo_link = 'https://wpfrank.com/demo/businessexpo-premium/';
									$thm_buy_link  = 'https://wpfrank.com/wordpress-themes/businessexpo-premium/';
									break;
								case 'Architect Designs':
									$thm_demo_link = 'https://wpfrank.com/demo/architect-design-premium/';
									$thm_buy_link  = 'https://wpfrank.com/wordpress-themes/businessexpo-premium/';
									break;
								case 'Crypto Mining':
									$thm_demo_link = 'https://wpfrank.com/demo/crypto-mining-premium/';
									$thm_buy_link  = 'https://wpfrank.com/wordpress-themes/crypto-airdrop-premium/';
									break;
								case 'Crypto Compare':
									$thm_demo_link = 'https://wpfrank.com/demo/crypto-compare-premium/';
									$thm_buy_link  = 'https://wpfrank.com/wordpress-themes/crypto-airdrop-premium/';
									break;
								case 'Building Construction':
									$thm_demo_link = 'https://wpfrank.com/demo/building-construction-premium/';
									$thm_buy_link  = 'https://wpfrank.com/wordpress-themes/businessexpo-premium/';
									break;
								case 'Crypto Token':
									$thm_demo_link = 'https://wpfrank.com/demo/crypto-token-pro/';
									$thm_buy_link  = 'https://wpfrank.com/wordpress-themes/crypto-airdrop-premium/';
									break;
								case 'Medical Health':
									$thm_demo_link = 'https://wpfrank.com/demo/medical-health-premium/';
									$thm_buy_link  = 'https://wpfrank.com/wordpress-themes/businessexpo-premium/';
									break;
							}
							?>
