...
/**
 * Class Avantex_Customizer_Repeater.
 */
class Avantex_Customizer_Repeater extends WP_Customize_Control {
	 ...
	 * @var bool
	 */
	public $customizer_repeater_btntitle_control = false;
	...
	/**
	 * Avantex_Customizer_Repeater constructor.
	 *
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->add_field_label = esc_html__( 'Add new field', 'avantex' );
		if ( ! empty( $args['add_field_label'] ) ) {
			$this->add_field_label = $args['add_field_label'];
		}

		$this->boxtitle = esc_html__( 'Customizer Repeater', 'avantex' );
		if ( ! empty( $args['item_name'] ) ) {
			$this->boxtitle = $args['item_name'];
		} elseif ( ! empty( $this->label ) ) {
			$this->boxtitle = $this->label;
		}
		$this->boxdesc = esc_html__( '', 'avantex' );
		if ( ! empty( $args['box_description'] ) ) {
			$this->boxdesc = $args['box_description'];
		}
		...
		if ( ! empty( $args['customizer_repeater_btntitle_control'] ) ) {
		...
		if ( file_exists( get_template_directory() . '/customizer-controls-master/customizer-repeater/inc/icons.php' ) ) {
			$this->customizer_icon_container = '/customizer-controls-master/customizer-repeater/inc/icons';
		}
	...
	public function enqueue() {
		wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/customizer-controls-master/customizer-repeater/fontawesome/css/fontawesome.min.css', array(), CUSTOMIZER_REPEATER_VERSION );
		wp_enqueue_style( 'font-awesome-brands', get_template_directory_uri() . '/customizer-controls-master/customizer-repeater/fontawesome/css/brands.css', array(), CUSTOMIZER_REPEATER_VERSION );
		wp_enqueue_style( 'font-awesome-solids', get_template_directory_uri() . '/customizer-controls-master/customizer-repeater/fontawesome/css/solid.css', array(), CUSTOMIZER_REPEATER_VERSION );
		wp_enqueue_style( 'font-awesome-v5', get_template_directory_uri() . '/customizer-controls-master/customizer-repeater/fontawesome/css/v5-font-face.css', array(), CUSTOMIZER_REPEATER_VERSION );
		wp_enqueue_style( 'font-awesome-v4', get_template_directory_uri() . '/customizer-controls-master/customizer-repeater/fontawesome/css/v4-font-face.css', array(), CUSTOMIZER_REPEATER_VERSION );

		wp_enqueue_style( 'customizer-repeater-admin-stylesheet', get_template_directory_uri() . '/customizer-controls-master/customizer-repeater/css/admin-style.css', array(), CUSTOMIZER_REPEATER_VERSION );

		wp_enqueue_style( 'wp-color-picker' );

		wp_enqueue_script( 'customizer-repeater-script', get_template_directory_uri() . '/customizer-controls-master/customizer-repeater/js/customizer_repeater.js', array( 'jquery', 'jquery-ui-draggable', 'wp-color-picker' ), CUSTOMIZER_REPEATER_VERSION, true );

		wp_enqueue_script( 'customizer-repeater-fontawesome-iconpicker', get_template_directory_uri() . '/customizer-controls-master/customizer-repeater/js/fontawesome-iconpicker.min.js', array( 'jquery' ), CUSTOMIZER_REPEATER_VERSION, true );

		wp_enqueue_style( 'customizer-repeater-fontawesome-iconpicker-script', get_template_directory_uri() . '/customizer-controls-master/customizer-repeater/css/fontawesome-iconpicker.min.css', array(), CUSTOMIZER_REPEATER_VERSION );
	}
	...
	public function render_content() {
		...
		<span class="description customize-control-description"><?php echo esc_html( $this->boxdesc ); ?></span>
				...
				<div class="customizer-repeater-general-control-repeater-container customizer-repeater-draggable">
					...
					<div class="customizer-repeater-box-content-hidden">
						...
						if ( $this->customizer_repeater_color_control == true ) {
							$this->input_control(
								array(
									'label'             => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Color', 'avantex' ), $this->id, 'customizer_repeater_color_control' ),
						...
						if ( $this->customizer_repeater_color2_control == true ) {
							$this->input_control(
								array(
									'label'             => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Color', 'avantex' ), $this->id, 'customizer_repeater_color2_control' ),
						...
						if ( $this->customizer_repeater_title_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Title', 'avantex' ), $this->id, 'customizer_repeater_title_control' ),
						...
						if ( $this->customizer_repeater_subtitle_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Subtitle', 'avantex' ), $this->id, 'customizer_repeater_subtitle_control' ),
						...
						if ( $this->customizer_repeater_text_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Text', 'avantex' ), $this->id, 'customizer_repeater_text_control' ),
						...
						if ( $this->customizer_repeater_btntitle_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Button Text', 'avantex' ), $this->id, 'customizer_repeater_btntitle_control' ),
									'class' => 'customizer-repeater-btntitle-control',
									'type'  => apply_filters( 'customizer_repeater_input_types_filter', '', $this->id, 'customizer_repeater_btntitle_control' ),
								),
								$btntitle
							);
						}
						if ( $this->customizer_repeater_link_control ) {
							$this->input_control(
								array(
									'label'             => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Link', 'avantex' ), $this->id, 'customizer_repeater_link_control' ),
						...
						if ( $this->customizer_repeater_text2_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Text', 'avantex' ), $this->id, 'customizer_repeater_text2_control' ),
						...
						if ( $this->customizer_repeater_link2_control ) {
							$this->input_control(
								array(
									'label'             => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Link', 'avantex' ), $this->id, 'customizer_repeater_link2_control' ),
						...
						if ( $this->customizer_repeater_shortcode_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Shortcode', 'avantex' ), $this->id, 'customizer_repeater_shortcode_control' ),
						...
						?>
						>
							<?php esc_html_e( 'Delete field', 'avantex' ); ?>
						</button>
...
>
			<span class="customize-control-title">
				<?php esc_html_e( 'Icon', 'avantex' ); ?>
			</span>
			<span class="description customize-control-description">
				<?php
				echo sprintf(
					/* translators: %1$s is Fontawesome link */
					esc_html__( 'Note: Some icons may not be displayed here. You can see the full list of icons at %1$s.', 'avantex' ),
					sprintf( '<a href="http://fontawesome.io/icons/" rel="nofollow">%s</a>', esc_html__( 'http://fontawesome.io/icons/', 'avantex' ) )
				);
				?>
			</span>
...
>
	...
	private function icon_type_choice( $value = 'customizer_repeater_icon' ) {
		?>
		<span class="customize-control-title">
			<?php esc_html_e( 'Image type', 'avantex' ); ?>
		</span>
		<select class="customizer-repeater-image-choice">
			<option value="customizer_repeater_icon" <?php selected( $value, 'customizer_repeater_icon' ); ?>><?php esc_html_e( 'Icon', 'avantex' ); ?></option>
			<option value="customizer_repeater_image" <?php selected( $value, 'customizer_repeater_image' ); ?>><?php esc_html_e( 'Image', 'avantex' ); ?></option>
			<option value="customizer_repeater_none" <?php selected( $value, 'customizer_repeater_none' ); ?>><?php esc_html_e( 'None', 'avantex' ); ?></option>
		</select>
		<?php
	}
	...
	private function repeater_control( $value = '' ) {
		...
		$show_del        = 0;
		?>
		<span class="customize-control-title"><?php esc_html_e( 'Social icons', 'avantex' ); ?></span>
		<?php
		...
		if ( ( count( $social_repeater ) == 1 && '' === $social_repeater[0] ) || empty( $social_repeater ) ) {
			...
			<div class="customizer-repeater-social-repeater">
				<div class="customizer-repeater-social-repeater-container">
					...
					<?php get_template_part( $this->customizer_icon_container ); ?>
					<input type="text" class="customizer-repeater-social-repeater-link" placeholder="<?php esc_attr_e( 'Link', 'avantex' ); ?>">
					<input type="hidden" class="customizer-repeater-social-repeater-id" value="">
					<button class="social-repeater-remove-social-item" style="display:none">
						<?php esc_html_e( 'Remove Icon', 'avantex' ); ?>
					</button>
				</div>
				<input type="hidden" id="social-repeater-socials-repeater-colector" class="social-repeater-socials-repeater-colector" value=""/>
			</div>
			<button class="social-repeater-add-social-item button-secondary"><?php esc_html_e( 'Add Icon', 'avantex' ); ?></button>
			<?php
		} else {
			?>
			<div class="customizer-repeater-social-repeater">
				...
				foreach ( $social_repeater as $social_icon ) {
					...
					<div class="customizer-repeater-social-repeater-container">
						...
						<?php get_template_part( $this->customizer_icon_container ); ?>
						<input type="text" class="customizer-repeater-social-repeater-link" placeholder="<?php esc_attr_e( 'Link', 'avantex' ); ?>" value="<?php if ( ! empty( $social_icon['link'] ) ) { echo esc_url( $social_icon['link'] ); } ?>">
						...
						<button class="social-repeater-remove-social-item" style="<?php if ( $show_del == 1 ) { echo 'display:none'; } ?>
						"><?php esc_html_e( 'Remove Icon', 'avantex' ); ?></button>
					</div>
					<?php
				}
				?>
