...
Tags: slider, image slider, photo slider, team slider, testimonial slider
...
Create responsive image slider, photo slider, video slider, team and testimonial slider with 12 templates.
...
**Free Plugin:** [DEMO](https://wpfrank.com/demo/slider-factory-free-wordpress-plugin/)
...
<code><?php do_shortcode('[sf id=1 layout=1]') ?></code>

When you create and save, it generate a shortcode, like below:

<code>[sf id=1 layout=1]</code>
...
**Pro Version:** [Details](https://wpfrank.com/wordpress-plugins/slider-factory-pro/)
**Pro Version:** [Live Demo](https://wpfrank.com/demo/slider-factory-pro/)
**Pro Version:** [Buy Now](https://wpfrank.com/account/signup/slider-factory-pro/)
...
* For more details check the [Plugin Documentation](https://wpfrank.com/slider-factory-free-wordpress-plugin-documentation/)
...
* Please follow this [link](https://wpfrank.com/slider-factory-free-wordpress-plugin-documentation/#install) to install the plugin.

= How to create a slideshow using plugin? =

* Please follow this [link](https://wpfrank.com/slider-factory-free-wordpress-plugin-documentation/#create).

= How to publish a slideshow on a page? =

* Please follow this [link](https://wpfrank.com/slider-factory-free-wordpress-plugin-documentation/#publish) publish on a page.
...
* Admin Dashboard
* All Layout And Shortcode Page
* Create and Mange Sliders
* Shortcode